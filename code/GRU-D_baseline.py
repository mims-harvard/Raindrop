...
def train_gru_d(num_runs, input_size, hidden_size, output_size, num_layers, dropout, learning_rate, n_epochs,
    ...
    print("missing ratio:{}, split type:{}, reverse:{}".format(missing_ratio, split_type, reverse_))
...
if __name__ == '__main__':
    ...
    for missing_ratio in missing_ratios:
        ...
        output_size = 1
        num_layers = 9  # 49 # num of step or layers base on the paper / number of hidden states
        dropout = 0.2  # dropout_type : Moon, Gal, mloss
