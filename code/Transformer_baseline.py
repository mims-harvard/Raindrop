...
for missing_ratio in missing_ratios:
    ...
    for k in range(n_splits):
        ...
        if missing_ratio > 0:  # Transformer
            ...
            if feature_removal_level == 'sample':
                ...
                if dataset == 'P12':
                    ...
                    dataset_prefix = 'P19_'
                    density_score_indices = np.array([3,  0,  1,  6,  4,  2,  5, 28, 33, 15, 25, 21, 29,  9, 18, 10, 23, 11, 12, 31, 17, 24,
                ...
                # density_score_indices =  np.array([0,1,2,5,6,16,31,32,3,27])  # sensor ranks for P12, the performnace is great in this case
