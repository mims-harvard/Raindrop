    ...
    for k in range(n_splits):
        ...
        for m in range(n_runs):
                ...
                if epoch ==0 or epoch % 1 == 0:
                    with torch.no_grad():
                        ...
                        if dataset == 'P12' or dataset == 'P19' or dataset == 'eICU':
                            ...
                            auc_val = roc_auc_score(one_hot_classes(yval, n_classes), out_val)
                            aupr_val = average_precision_score(one_hot_classes(yval, n_classes), out_val)
            ...
            with torch.no_grad():
                ...
                n_batches = math.ceil(Ptest_tensor.size()[1].size()[0] / batch_size)
                ...
                if dataset == 'P12' or dataset == 'P19' or dataset == 'eICU':
                    ...
                    auc = roc_auc_score(one_hot_classes(ytest, n_classes), probs)
                    aupr = average_precision_score(one_hot_classes(ytest, n_classes), probs)
